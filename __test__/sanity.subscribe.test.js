...
//     console.log('subscribe.is_active', count++, is_active);
//   });
//   await sleep(2000);
...
//   console.log('unsubscribe changes')
//   obs.unsubscribe();
...
//     console.log('subscribe.profile', count++, data);
//   });
...
//   console.log('instance.profile.display_name', await instance.getByPath('profile.display_name'));
...
//   let count = 0;
//   const obs = subscription.subscribe((data) => {
//     console.log('subscribe.profile.display_name', count++, data);
//   });
...
//   let count = 0;
//   const obs = subscription.subscribe((data) => {
//     console.log('subscribe.transactions', count++, _.map(data, 'id'));
//   });
...
//   let count = 0;
//   const obs = subscription.subscribe((data) => {
//     console.log('subscribe.transactions', count++, data);
//   });
...
//   let count = 0;
//   const obs = subscription.subscribe((data) => {
//     console.log('subscribe.transaction.length', count++, data);
//   });
